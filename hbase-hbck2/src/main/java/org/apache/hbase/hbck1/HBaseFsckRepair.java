...
/**
 * This class contains helper methods that repair parts of hbase's filesystem contents. Copied over
 * wholesale from hbase. Unaltered except for package and imports.
 */
